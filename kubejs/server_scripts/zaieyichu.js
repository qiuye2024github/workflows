BlockEvents.rightClicked((event) => {
    ...
    // 目标方块为石英块 物品是钻石块 召唤怪人 消耗材料 
    summonBoss('minecraft:quartz_block', 'minecraft:diamond_block', 'illageandspillage:freakager', true)
    // 目标方块为石英块 物品是绿宝石块 召唤魔法师 消耗材料 
    summonBoss('minecraft:quartz_block', 'minecraft:emerald_block', 'illageandspillage:magispeller', true)
    // 目标方块为石英块 物品是下界合金块 召唤灵魂感应师 消耗材料 
    summonBoss('minecraft:quartz_block', 'minecraft:netherite_block', 'illageandspillage:spiritcaller', true)
